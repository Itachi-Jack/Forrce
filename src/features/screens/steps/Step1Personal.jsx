...
import PersonalInfoCard from "../components/sections/PersonalInfoCard";

// export default function Step1Personal(props) {
...
export default function Step1Personal({ form, setForm }) {
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={[styles.pickerWrap]}>
        <RNPickerSelect
          onValueChange={(val) => {
            setForm({...form , is_self_pickup : val})
          }}
          value={form.is_self_pickup}
      ...
      <View style={styles.pickerWrap}>
        <RNPickerSelect
          onValueChange={(val) => {
            setForm({...form , is_courier:val})
          }}
          value={form.is_courier}
          placeholder={{ label: "Select an option", value: null }}
          items={[
            { label: "Yes", value: true },
            { label: "No", value: false },
